 ...
 */
final class Version20231030011944 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE review (id INT NOT NULL, car_id INT NOT NULL, rating INT NOT NULL, text TEXT NOT NULL, PRIMARY KEY(id))');
